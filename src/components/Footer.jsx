const navigation = {
  solutions: [
    { name: 'Inicio', href: '#' },
    { name: 'Analytics', href: '#' },
    { name: 'Servicios', href: '#ContactUs' },
    { name: 'Insights', href: '#aboutUs' },
  ],
  social: [
    {
      name: 'Facebook',
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-8 xl:mt-0">
            <h3 className="text-base font-medium text-gray-900">Trabaja con nosotros</h3>
            <p className="mt-4 text-base text-gray-500">
            Si eres técnico, tecnólogo, profesional o especialista con licencia en SST, no dudes en contactarnos.
            </p>
